...
// Roc extern function declarations
// These are generated by the Roc compiler in the app's LLVM IR
...
export fn entrypoint(input: [*]u8) callconv(.c) u64 {
    ...
    if (is_bpf) {
        // In BPF mode, call the actual Roc function
        roc__main_for_host_1_exposed_generic(&roc_result);
